 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9090/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/BanqueService?wsdl");
